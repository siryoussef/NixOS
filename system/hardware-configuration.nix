...

{
  ...
  ## Bind Mounts
    ...
    "/home/youssef/Downloads" = { device = "/Volume/@Storage/Downloads"; options = ["bind"]; depends = [ "/" "/home" "/Volume"]; };
    "/home/youssef/.floorp" = { device = "/Shared/@Home/.floorp"; fsType = "none"; options = [ "bind" ]; };
    "/home/youssef/.vscode" = { device = "/Shared/@Home/.vscode"; fsType = "none"; options = [ "bind" ]; };
    "/home/youssef/.local/share/fish" = { device = "/Shared/@Home/fish"; fsType = "none"; options = [ "bind" ]; };
    "/home/youssef/.config/GitHub Desktop" = { device = "/Shared/@Home/.config/GitHub Desktop"; fsType = "none"; options = [ "bind" ]; };
    "/home/youssef/Documents/GitHub" = { device = "/Shared/@Repo"; fsType = "none"; options = [ "bind" ]; };
    };
